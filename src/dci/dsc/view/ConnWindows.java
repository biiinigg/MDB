...
import dci.dsc.controller.ConnectController;
...
public class ConnWindows {
	 ...
	 */
	public ConnWindows(String dbtype) {
		this.dbtype=dbtype;
		initialize();
	...
	public void initdata(){
		if(this.dbtype.equals(DBEnum.Type.MYSQL.toString())){
			_ip.setText("localhost");
			_port.setText("3306");
		}else if(this.dbtype.equals(DBEnum.Type.ORACLE.toString())){
			_ip.setText("localhost");
			_port.setText("1521");
		}else if(this.dbtype.equals(DBEnum.Type.SQLSERVER.toString())){
			_ip.setText("localhost");
			_port.setText("1433");
		}
	}
	public String getdata(){
		return _cname.getText()+";"+type.getText()+";"+_sid.getText()+";"+_ip.getText()+";"+_ac.getText()+";"+_pw.getText()+";"+_port.getText();
	}
	...
	private void initialize() {
		frame = new JFrame();
		frame.setTitle("連線資訊");
		frame.setBounds(100, 100, 406, 323);
		...
		type.setText(cc.getDBtype(this.dbtype));
		type.disable();
		initdata();
